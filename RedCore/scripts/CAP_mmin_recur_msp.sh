...
cmd="python3 train_miss_recur.py --dataset_mode=multimodal_miss_msp --model=redcore_mmin
...
--name=redcore4_mmin_MSP --suffix=block_{n_blocks}_run{run_idx} --has_test
--cvNo=1
--rate_indx=$i"
