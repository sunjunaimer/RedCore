...
class CraMultimodalMissDataset(BaseDataset):
    @staticmethod
    def modify_commandline_options(parser, isTrain=None):
        ...
        parser.add_argument('--corpus_name', type=str, default='cra_IEMOCAP', help='which dataset to use')
        return parser
    ...
    def __init__(self, opt, set_name):
        ...
        if set_name != 'trn':           # val && tst
            ...
            self.miss_type = ['azz', 'zvz', 'zzl', 'avz', 'azl', 'zvl','nnn'] * len(self.label)
        else:                           # trn
            self.missing_index = [
                # [1,0,0], # AZZ
                # [0,1,0], # ZVZ
            ...
            self.miss_type = ['azz', 'zvz', 'zzl', 'avz', 'azl', 'zvl', 'azz', 'zvz', 'zzl', 'avz', 'azl', 'zvl', 'nnn']
